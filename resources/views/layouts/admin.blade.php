            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{$url=='categories'?'active':''}}">
                        <a href="{{url('admin/categories')}}"><i class="menu-icon fa fa-list-ul"></i>Blog </a>
                    </li>
                    ...
                    <li class="{{$url=='destinations'?'active':''}}">
                        <a href="{{url('admin/destinations')}}"><i class="menu-icon fa fa-paper-plane-o"></i>Properti</a>
                    </li>
