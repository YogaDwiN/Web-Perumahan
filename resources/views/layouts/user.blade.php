...
<body>
    ...
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          ...
          <h2 class="d-inline text-light">RESIDANCE BORNEO KHATULISTIWA</h2>
        </a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="{{$url=='destination'?'menu-active':''}}"><a href="{{url('destination')}}">Properties</a></li>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>YDN</strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="#">Yoga</a>
      </div>
    </div>
  </footer><!-- #footer -->
